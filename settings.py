...
# Django settings for gentlemens_gt project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gtdb.sqlite',  # Or path to database file if using sqlite3.
...
MEDIA_ROOT = BASE_PATH + '/static/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash if there is a path component (optional in other cases).
# Examples: "http://media.lawrence.com", "http://example.com/media/"
MEDIA_URL = '/gentlemens_gt/static/'
...
SECRET_KEY = '@_u_csvry1!9tfk@^js)4@ofm=jb%6d_$3sjoyc_(6+#gzzz=p'
...
ROOT_URLCONF = 'gentlemens_gt.urls'
