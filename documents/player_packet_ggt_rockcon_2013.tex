...
\newcommand{\costlyunit}{\paragraphsmall{Costly Unit} Destroy your opponent's most expensive unit. If more than one unit qualifies as the most expensive unit, choose the enemy unit that will count for the purposes of this objective.}
...
\subsection*{Not Enough to Go Around}
...
\subsection*{Once More Unto the Breach}
