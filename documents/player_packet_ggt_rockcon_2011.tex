...
%
\newcommand{\victorypoints}{\paragraphsmall{Victory Points} Accumulate at least 250 Victory Points more than your opponent. Employ the Victory Points rules from p. 300 of the Warhammer 40,000 rulebook \textbf{Reference}.}
%
\newcommand{\annihilation}{Follow the \textbf{Annihilation} standard mission rules defined on p. 91 of the Warhammer 40,000 rulebook.}
%
...
%
\newcommand{\seizeground}[1]{Follow the \textbf{Seize Ground} standard mission rules defined on p. 91 of the Warhammer 40,000 rulebook, except that you must employ #1 objective markers.}

\begin{document}
\begin{titlepage}
\title{The Gentlemen's Grand Tournament\\{\large\textit{A Weekend of Bloodletting and Crumpets}}}
\author{RockCon}
\date{November 5--6, 2011\\Rockford, Illinois}
\maketitle
\end{titlepage}
...
\paragraphsmall{Domination} Have more Victory Points' worth of units---including at least one \textit{Scoring Unit}---within \inches{12} of the table's center point than your opponent. At least 50\% of a unit must reside within this area to count. A player that has at least as many Victory Points' worth of units within range of the center as their opponent but without any \textit{Scoring Units} has successfully \textit{contested} this \textbf{Objective}.
