...
%
\newcommand{\gameboilerplate}{This mission follows all the normal rules for games of Warhammer 40,000 as outlined in the \textbf{Fighting a Battle} chapter of the Warhammer 40,000 rulebook except as already noted in your tournament rules packet and described below.}
%
...
\vspace{6pt}
\noindent\begin{tabular}[t]{@{}l@{\quad}l@{\hspace{1.4in}}l@{\quad}l@{\quad}l@{}}
 ...
 \textbf{Default} & 1 & \textbf{Default} & 1 & {\scriptsize *See pp. 4--5 of this rules packet.}\\[3pt]
\end{tabular}
...
%
\newcommand{\tablequarters}{\paragraphsmall{Table Quarters} The table is divided into four quarters, formed by drawing two imaginary perpendicular lines through the center point. Players \textit{claim} a table quarter by having more \textit{Victory Points'} worth of units---including at least one \textit{Scoring Unit}---in the quarter than their opponent. For the purposes of this \textbf{Objective}, \textit{Scoring Units} are worth \textit{3 Victory Points} each, non-\textit{Scoring Units} are worth \textit{1 Victory Point} each. A player that has at least as many \textit{Victory Points'} worth of units in a quarter as their opponent but without any \textit{Scoring Units} has successfully \textit{contested} that quarter.
...
%
\newcommand{\domination}{\paragraphsmall{Domination} Have more \textit{Victory Points'} worth of units---including at least one \textit{Scoring Unit}---within \inches{12} of the table's center point than your opponent. At least 50\% of a unit must reside within this area to count. For the purposes of this \textbf{Objective}, \textit{Scoring Units} are worth \textit{3 Victory Points} each, non-\textit{Scoring Units} are worth \textit{1 Victory Point} each. A player that has at least as many \textit{Victory Points'} worth of units within range of the center as their opponent but without any \textit{Scoring Units} has successfully \textit{contested} this \textbf{Objective}.}
%
\newcommand{\leadbyexample}{\paragraphsmall{Lead by Example} Have one of your HQ Independent Character, Monstrous Creature, or Walker models anywhere within \inches{16} of your opponent's table edge at the end of the game.}

\begin{document}
\begin{titlepage}
\title{The Gentlemen's Grand Tournament\\{\large\textit{A Weekend of Bloodletting and Crumpets}}}
\author{RockCon}
\date{November 20--21, 2012\\Rockford, Illinois}
\maketitle
\end{titlepage}
...
\item Tournament Missions
  \begin{itemize}
  \item Round 5: ``Can't Spare Anyone"
  \item Round 4: ``Five by Five"
  \item Round 3: ``Cry Havoc!"
  \item Round 2: ``Grinder"
  \item Round 1: ``If I Can't Have It \ldots"
  \end{itemize}
\end{itemize}
...
Several awards will be presented at the tournament. Regardless of scoring, no participant may earn more than one award. If a participant is eligible for multiple awards, the Tournament Organizer shall decide which one to present to that person, promoting the next highest ranked participant for the other award(s).
...
\subsection*{Day 1: Saturday, November 5}

\begin{tabular}[t]{@{}l@{\quad}l@{}}
\phantom{1}9:00 AM--10:00 AM & Player registration, army appearance judging \\
10:00 AM--12:15 PM & Round 1 \\
12:15 PM--\phantom{1}1:00 PM & Lunch, army appearance judging completion (if required) \\
\phantom{1}1:00 PM--\phantom{1}3:15 PM & Round 2 \\
\phantom{1}3:30 PM--\phantom{1}5:45 PM &  Round 3 \\
\end{tabular}

\subsection*{Day 2: Sunday, November 6}
...
You \textit{must} nominate one of your opponents as your \textbf{Favorite Opponent}. See page 5 of your tournament rules packet for guidelines. Please submit this vote after your final (Round 5) game on Sunday.
...
You \textit{must} nominate one tournament participant as having created your \textbf{Favorite Army}. See page 5 of your tournament rules packet for guidelines. Please submit this vote by the time you finish your Round 3 game on Saturday.
...
\paragraphsmall{Domination} Have more \textit{Victory Points'} worth of units---including at least one \textit{Scoring Unit}---within \inches{12} of the table's center point than your opponent. At least 50\% of a unit must reside within this area to count. For the purposes of this \textbf{Objective}, \textit{Scoring Units} are worth \textit{3 Victory Points} each, non-\textit{Scoring Units} are worth \textit{1 Victory Point} each. A player that has at least as many \textit{Victory Points'} worth of units within range of the center as their opponent but without any \textit{Scoring Units} has successfully \textit{contested} this \textbf{Objective}.
...
\paragraphsmall{Slaughter} Accumulate at least 750 Victory Points. Employ the Victory Points rules from p. 300 of the Warhammer 40,000 rulebook \textbf{Reference}.

\vspace{-2pt}
\subsubsection*{Tertiary Objective}

\paragraphsmall{Overrun} Have more Victory Points' worth of units---including at least one \textit{Scoring Unit}---in your opponent's deployment zone than your opponent has in your own deployment zone. (\textit{Not} your opponent's deployment table quarter, your opponent's \textit{deployment zone!}) A \textit{majority} of a unit must be within the zone to count. A player that has at least as many Victory Points' worth of units in their opponent's deployment zone as their opponent---but without any \textit{Scoring Units}---has successfully \textit{contested} this \textbf{Objective}.
...
\section*{Round 1}
\vspace{-6pt}
\subsection*{If I Can't Have It \ldots}
{\footnotesize
\gameboilerplate
...
\paragraphsmall{Defend the Flag} After determining who goes first, but before deploying their armies, the players alternate turns placing a total of 6 objective markers, starting with the player who has the first turn.
...
\paragraphsmall{Lead by Example} Have one of your HQ Independent Character, Monstrous Creature, or Walker models anywhere within \inches{16} of your opponent's deployment table edge at the end of the game.
